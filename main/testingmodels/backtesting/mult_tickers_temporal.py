...
import pandas as pd
import numpy as np
from ...modelcode.better_mult_stocks_5min import TemporalAttention
...
model_name = "multiple_stocks_model_5min_temporal_5"
model = keras.models.load_model(
    os.path.join(model_path, model_name + '.keras'),
